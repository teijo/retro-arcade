...
var Audio = _react2["default"].createClass({
  ...
  propTypes: {
    audioId: _react2["default"].PropTypes.number.isRequired,
    file: _react2["default"].PropTypes.string.isRequired
  },
  render: function render() {
    return _react2["default"].createElement(
      "audio",
      { ref: "element", id: "audio-" + this.props.audioId, crossOrigin: "anonymous" },
      _react2["default"].createElement("source", { src: this.props.file, type: "audio/wav" })
    );
  }
});

var loadAudioContext = function loadAudioContext() {
  ...
  _react2["default"].render(_react2["default"].createElement(
    ...
    files.map(function (f, index) {
      return _react2["default"].createElement(Audio, { key: index, audioId: index, file: f });
    })
  ...
  return files.map(function (_, index) {
    return player(index);
  });
};
...
function disableClassOnAnimationEnd(ref, className) {
  var node = _react2["default"].findDOMNode(ref);
  _Bacon2["default"].fromEvent(node, "animationend").onValue(function () {
    return node.classList.toggle(className, false);
  });
}
...
var AnimatedCounter = _react2["default"].createClass({
  displayName: "AnimatedCounter",
  ...
  componentWillUpdate: function componentWillUpdate() {
    _react2["default"].findDOMNode(this.refs.cursor).classList.toggle("bump", true);
  },
  render: function render() {
    return _react2["default"].createElement(
      "span",
...
var Splatter = _react2["default"].createClass({
  ...
  componentWillUpdate: function componentWillUpdate() {
    _react2["default"].findDOMNode(this.refs.splash).classList.toggle("splash", true);
  },
  render: function render() {
    var text = this.props.value == 0 ? "" : "PERFECT " + this.props.value + "X!";
    return _react2["default"].createElement(
      "div",
      { className: "splatter-container" },
      _react2["default"].createElement(
        "span",
        { ref: "splash", className: "splatter" },
        text
      )
    );
  }
...
var Game = _react2["default"].createClass({
  ...
  render: function render() {
    ...
    var consecutiveSpecialHits = _props$state.consecutiveSpecialHits;
    var progress = _props$state.progress;
    var score = _props$state.score;
    var blockPosition = _props$state.blockPosition;
    var blockIndex = _props$state.blockIndex;
    var specialsLeft = _props$state.specialsLeft;
    var world = _props$state.world;
    ...
    return _react2["default"].createElement(
      ...
      _react2["default"].createElement(CodeBox, { blockPosition: blockPosition,
        blockIndex: blockIndex,
        blocks: world.blocks }),
      _react2["default"].createElement(Splatter, { value: consecutiveSpecialHits }),
      _react2["default"].createElement(
        "div",
        { className: "footer" },
        _react2["default"].createElement(
          "div",
          { className: "col" },
          _react2["default"].createElement(AnimatedCounter, { value: Math.round(progress) }),
          _react2["default"].createElement(
            "span",
            { className: "title" },
            "Progress"
        ...
        _react2["default"].createElement(
          "div",
          { className: "col" },
          _react2["default"].createElement(AnimatedCounter, { value: score }),
          _react2["default"].createElement(
            "span",
            { className: "title" },
            "Score"
        ...
        _react2["default"].createElement(
          "div",
          { className: "col" },
          _react2["default"].createElement(AnimatedCounter, { value: specialsLeft }),
          _react2["default"].createElement(
            "span",
            { className: "title" },
            "Specials"
...
var PassedBlock = _react2["default"].createClass({
  displayName: "PassedBlock",
  ...
  render: function render() {
    var classes = (0, _classNames2["default"])(typeToClassName(this.props.type), { finish: this.props.animate });
    return _react2["default"].createElement(
      "span",
      { ref: "block", style: { color: "red" }, className: classes },
      this.props.content
    );
  }
});

var ActiveBlock = _react2["default"].createClass({
  displayName: "ActiveBlock",

  propTypes: {
    content: _react2["default"].PropTypes.string.isRequired,
    position: _react2["default"].PropTypes.number.isRequired,
    onInput: _react2["default"].PropTypes.func.isRequired,
    type: _react2["default"].PropTypes.any.isRequired
  },
  componentDidUpdate: function componentDidUpdate() {
    var cursor = _react2["default"].findDOMNode(this.refs.cursor);
    if (cursor === null) {
      return;
    }
  ...
  render: function render() {
    ...
    var completed = content.substr(0, position);
    var cursor = content.substr(position, 1);
    var left = content.substr(position + 1);
    return _react2["default"].createElement(
      "span",
      { className: typeToClassName(this.props.type) },
      _react2["default"].createElement(PassedBlock, { animate: false, type: this.props.type, content: completed }),
      _react2["default"].createElement(
        "span",
        { style: { backgroundColor: "lime" }, ref: "cursor" },
        cursor
      ),
      _react2["default"].createElement("span", { dangerouslySetInnerHTML: { __html: left } })
    );
  }
});

var UpcomingBlock = _react2["default"].createClass({
  displayName: "UpcomingBlock",
...
var UpcomingNextBlock = _react2["default"].createClass({
  displayName: "UpcomingNextBlock",
  ...
  render: function render() {
    return _react2["default"].createElement(
      ...
      _react2["default"].createElement(
        "span",
        { style: { backgroundColor: "lime" }, ref: "cursor" },
        this.props.content.substr(0, 1)
      ),
      _react2["default"].createElement("span", { dangerouslySetInnerHTML: { __html: this.props.content.substr(1) } })
    );
  }
});

var CodeBox = _react2["default"].createClass({
  displayName: "CodeBox",

  propTypes: {
    blockPosition: _react2["default"].PropTypes.number.isRequired,
    blockIndex: _react2["default"].PropTypes.number.isRequired,
    blocks: _react2["default"].PropTypes.array.isRequired
  },
  onInput: function onInput(cursorOffsetLeft, cursorOffsetTop) {
    var node = this.getDOMNode();
  ...
  render: function render() {
    ...
    var blockPosition = _props2.blockPosition;
    var blockIndex = _props2.blockIndex;
    var blocks = _props2.blocks;

    var elements = blocks.map(function (block, index) {
      var key = "block_" + index;
      if (index == blockIndex && blockPosition < blocks[blockIndex].text.length) {
        return _react2["default"].createElement(ActiveBlock, { key: key, type: block.type, onInput: _this.onInput, content: block.text, position: blockPosition });
      } else if (index <= blockIndex) {
        return _react2["default"].createElement(PassedBlock, { animate: true, type: block.type, content: block.text, key: key });
      } else {
        // Previous block finished, cursor jumps to current block
        if (blockIndex == index - 1 && blockPosition == blocks[blockIndex].text.length) {
          return _react2["default"].createElement(UpcomingNextBlock, { key: key, type: block.type, content: block.text });
        } else {
          return _react2["default"].createElement(UpcomingBlock, { key: key, type: block.type, content: block.text });
        }
      }
    });
    return _react2["default"].createElement(
...
var Countdown = _react2["default"].createClass({
  ...
  render: function render() {
    return _react2["default"].createElement(
      "span",
      { className: "countdown", ref: "cursor" },
      this.props.value
    );
  }
});

var GameTime = _react2["default"].createClass({
...
var GamePage = _react2["default"].createClass({
  ...
  propTypes: {
    states: _react2["default"].PropTypes.array.isRequired,
    settings: _react2["default"].PropTypes.array.isRequired,
  ...
  render: function render() {
    ...
    return _react2["default"].createElement(
      "div",
      null,
      _react2["default"].createElement(Countdown, { value: this.props.page.countdown }),
      _react2["default"].createElement(GameTime, { value: this.props.page.timeLeft }),
      _react2["default"].createElement(
        "div",
        { className: "game" },
        this.props.states.map(function (p, index) {
          return _react2["default"].createElement(Game, { key: "player_" + index, settings: _this2.props.settings[index], state: p });
        })
      )
    );
  }
...
var PlayerName = _react2["default"].createClass({
  ...
  componentDidMount: function componentDidMount() {
    _Bacon2["default"].fromEvent(_react2["default"].findDOMNode(this.refs.input), "keyup").map(function (e) {
      return e.target.value;
    }).onValue(this.props.onchange);
  },
  render: function render() {
    return _react2["default"].createElement("input", { placeholder: this.props.placeholder, ref: "input", type: "text" });
  }
});

var MenuPage = _react2["default"].createClass({
  displayName: "MenuPage",

  propTypes: {
    states: _react2["default"].PropTypes.array.isRequired,
    settings: _react2["default"].PropTypes.array.isRequired,
    outputs: _react2["default"].PropTypes.object.isRequired,
    navigation: _react2["default"].PropTypes.array.isRequired
  },
  render: function render() {
    return _react2["default"].createElement(
      "div",
      ...
      _react2["default"].createElement(
        "div",
        null,
        _react2["default"].createElement(PlayerName, { placeholder: this.props.settings[0].name, onchange: this.props.outputs.player1Name }),
        _react2["default"].createElement(PlayerName, { placeholder: this.props.settings[1].name, onchange: this.props.outputs.player2Name })
      ),
      _react2["default"].createElement(
        "ul",
        null,
        this.props.navigation.map(function (item, index) {
          return _react2["default"].createElement(
            "li",
            { key: index },
            _react2["default"].createElement(
              "a",
              { className: (0, _classNames2["default"])({ selected: item.selected }), href: item.link },
              item.label
            )
          );
        })
...
var WorldSelectPage = _react2["default"].createClass({
  displayName: "WorldSelectPage",
    ...
    return _react2["default"].createElement(
      ...
      _react2["default"].createElement(
        ...
        this.props.navigation.map(function (item, index) {
          return _react2["default"].createElement(
            "li",
            { className: (0, _classNames2["default"])({ selected: item.selected }), key: index },
            _react2["default"].createElement(
              "a",
              { href: item.link },
              item.label
...
exports.WorldSelectPage = WorldSelectPage;
var HowtoPage = _react2["default"].createClass({
  ...
  render: function render() {
    ...
    var _props$navigation = _slicedToArray(this.props.navigation, 1);

    var navigation = _props$navigation[0];
    ...
    return _react2["default"].createElement(
      ...
      _react2["default"].createElement(
        ...
        _react2["default"].createElement(
          "li",
          null,
          "Repeat \"LEFT\" and \"RIGHT\" to advance"
        ),
        _react2["default"].createElement(
          "li",
          null,
          "Press \"A\" to use AUTOCOMPLETE when entering ",
          _react2["default"].createElement(
            "span",
      ...
      _react2["default"].createElement(
        "ul",
        null,
        this.props.states.map(function (s, index) {
          return _react2["default"].createElement(
            "li",
            { key: index },
            _this3.props.settings[index].name,
            " LEFT: ",
            s.keys.LEFT,
            ", RIGHT: ",
            s.keys.RIGHT,
      ...
      _react2["default"].createElement(
        ...
        _react2["default"].createElement(
          ...
          " gives score multiplier only when autocompleted"
        ),
        _react2["default"].createElement(
          "li",
          null,
          _react2["default"].createElement(
            "span",
            { className: "block-special-add" },
            "AUTOCOMPLETE+1"
          ),
          " gives one autocomplete command when passed"
        )
      ),
      _react2["default"].createElement(
        "a",
        { className: (0, _classNames2["default"])({ selected: navigation.selected }), href: navigation.link },
        navigation.label
      )
    );
  }
...
exports.HowtoPage = HowtoPage;
var ScorePage = _react2["default"].createClass({
  ...
  render: function render() {
    ...
    var _props$navigation2 = _slicedToArray(this.props.navigation, 1);

    var navigation = _props$navigation2[0];

    var maxScore = this.props.states.reduce(function (max, state) {
      return Math.max(max, state.score);
    }, 0);
    return _react2["default"].createElement(
      "div",
      { className: "score" },
      ...
      _react2["default"].createElement(
        ...
        null,
        this.props.states.map(function (s, index) {
          var classes = (0, _classNames2["default"])('resultScore', { winner: s.score === maxScore });
          return _react2["default"].createElement(
            "li",
            { key: index },
            _react2["default"].createElement(
              "h2",
              null,
              _this4.props.settings[index].name
            ),
            _react2["default"].createElement(
              "p",
              { className: classes },
...
},{"./const":7,"Bacon":1,"classNames":2,"react":4}],7:[function(require,module,exports){
"use strict";
...
var TIME_DELAY = 1000,
    // Length of a timer tick in milliseconds, for clocks
GAME_TIME = 60,
    KEY_NORMAL = Symbol("normal-key"),
    KEY_SPECIAL = Symbol("special-key"),
    TYPE_NORMAL = Symbol("normal block type"),
    TYPE_BONUS = Symbol("bonus block type"),
    TYPE_GET_SPECIAL = Symbol("get special block type");
exports.TIME_DELAY = TIME_DELAY;
exports.GAME_TIME = GAME_TIME;
exports.KEY_NORMAL = KEY_NORMAL;
exports.KEY_SPECIAL = KEY_SPECIAL;
exports.TYPE_NORMAL = TYPE_NORMAL;
exports.TYPE_BONUS = TYPE_BONUS;
exports.TYPE_GET_SPECIAL = TYPE_GET_SPECIAL;
...
var World = _interopRequireWildcard(_worlds);

var nextStep = (function () {
  var STEP_MULTIPLIER = 8;
  var SPECIAL_STEP_MULTIPLIER = 32;

  var Movement = {
    indentSkip: function indentSkip(block, position) {
    ...
    jump: function jump(step, blocks, index, position) {
      var blockLength = blocks.get(index).get('text').length;
    ...
    step: function step(position) {
      return position + 1;
    },
    getPosition: function getPosition(blocks, step) {
      var blockIndex = -1;
      var next = step;
  ...
  var getBlocks = function getBlocks(state) {
    return state.getIn(['world', 'blocks']);
  };
  var getWorldLength = function getWorldLength(state) {
    return state.getIn(['world', 'length']);
  };
  ...
  function applyNormalKey(state) {
    var currentPosition = Movement.step(state.get('step')) + Movement.indentSkip(getBlocks(state).get(state.get('blockIndex')).get('text'), state.get('blockPosition'));
    var stepScore = (currentPosition - state.get('step')) * STEP_MULTIPLIER;

    var _Movement$getPosition = Movement.getPosition(getBlocks(state), currentPosition);

    var _Movement$getPosition2 = _slicedToArray(_Movement$getPosition, 2);

    var blockIndex = _Movement$getPosition2[0];
    var blockPosition = _Movement$getPosition2[1];
  ...
  function applySpecialKey(state) {
    ...
    if (state.get('specialsLeft') > 0) {
      var _Movement$jump = Movement.jump(state.get('step'), getBlocks(state), state.get('blockIndex'), state.get('blockPosition'));

      var _Movement$jump2 = _slicedToArray(_Movement$jump, 2);

      hitPosition = _Movement$jump2[0];
      currentPosition = _Movement$jump2[1];
    } else {
      hitPosition = -1;
      currentPosition = state.get('step');
    }
    // Perfect hit
    if (hitPosition === 0) {
    ...
    var _Movement$getPosition3 = Movement.getPosition(getBlocks(state), currentPosition);

    var _Movement$getPosition32 = _slicedToArray(_Movement$getPosition3, 2);

    var blockIndex = _Movement$getPosition32[0];
    var blockPosition = _Movement$getPosition32[1];
  ...
  return function (initialState, timeAndKey) {
    if (initialState.get('step') == getWorldLength(initialState)) {
      return initialState;
    }

    var keyType = timeAndKey.keyType;
    var timeLeft = timeAndKey.timeLeft;
...
function registerKey(key) {
  return _Bacon2["default"].fromEvent(window, "keypress").map(function (e) {
    return e.keyCode;
...
function sequenceStream(keyConfig, sequence) {
  var keySequence = sequence.map(function (command) {
    return keyConfig[command];
  });
  var keyE = keySequence.map(registerKey);
  return _Bacon2["default"].mergeAll(keyE).scan({ n: 0, loops: 0, seq: keySequence }, function (conf, key) {
...
var player1NameChangeE = new _Bacon2["default"].Bus();
var player2NameChangeE = new _Bacon2["default"].Bus();
var outputs = {
  player1Name: function player1Name(name) {
    player1NameChangeE.push(name);
  },
  player2Name: function player2Name(name) {
    player2NameChangeE.push(name);
  }
};

function timer(count, delay) {
  return _Bacon2["default"].interval(delay || 1000).scan(count, function (t) {
    return t - 1;
...
var isGameHash = function isGameHash(hash) {
  return hash.startsWith("#game");
};

var pageHashP = _Bacon2["default"].fromEvent(window, "hashchange").toProperty({ newURL: window.location.hash }).map(function (e) {
  var parts = e.newURL.split("#");
  return parts.length == 2 ? "#" + parts[1] : "#menu";
});

var activePageP = pageHashP.flatMapLatest(function (hash) {
  if (isGameHash(hash)) {
    return _Bacon2["default"].sequentially(Const.TIME_DELAY, ["3", "2", "1", "CODE!", ""]).toProperty("READY?") // immediate start from first countdown element
    .flatMap(function (c) {
      return _Bacon2["default"].combineTemplate({
        hash: hash,
        countdown: c,
    ...
    return _Bacon2["default"].constant({ hash: hash });
  }
}).toProperty();

var gameIsActiveP = activePageP.map(function (page) {
  return isGameHash(page.hash) && page.countdown === "";
});

var gameTimeLeftP = activePageP.filter(function (page) {
  return isGameHash(page.hash);
}).map(function (page) {
  return page.timeLeft;
});

var resetStateE = _Bacon2["default"].mergeAll(
// Force reset on "Q"
_Bacon2["default"].mergeAll(_Bacon2["default"].once(), registerKey("q")),
// Reset on menu->game page transition
activePageP.slidingWindow(2, 2).filter(function (w) {
  return w[0].hash === "#worldSelect" && isGameHash(w[1].hash);
})).map("[reset state]");

var playerSettingsP = _Bacon2["default"].combineAsArray([{
  name: player1NameChangeE.toProperty("Player 1")
}, {
  name: player2NameChangeE.toProperty("Player 2")
}].map(_Bacon2["default"].combineTemplate));

var player1Keys = { LEFT: 'a', RIGHT: 'd', DOWN: "s", UP: "w", A: "f", B: "g" };
var player2Keys = { LEFT: 'j', RIGHT: 'l', DOWN: "k", UP: "i", A: ";", B: "'" };

var pageComponentE = activePageP.map(function (page) {
  switch (page.hash) {
    case "#worldSelect":
      return function (states, settings, navigation) {
        return _react2["default"].createElement(_components.WorldSelectPage, { navigation: navigation });
      };
    case "#howto":
      return function (states, settings, navigation) {
        return _react2["default"].createElement(_components.HowtoPage, { states: states, settings: settings, navigation: navigation });
      };
    case "#game-hs":
    case "#game-asm":
    case "#game-js":
      return function (states, settings, navigation) {
        return _react2["default"].createElement(_components.GamePage, { states: states, page: page, settings: settings });
      };
    case "#score":
      return function (states, settings, navigation) {
        return _react2["default"].createElement(_components.ScorePage, { states: states, settings: settings, navigation: navigation });
      };
    default:
      return function (states, settings, navigation) {
        return _react2["default"].createElement(_components.MenuPage, { states: states, settings: settings, outputs: outputs, navigation: navigation });
      };
  }
});
...
var isGamePageP = activePageP.map(function (p) {
  return isGameHash(p.hash);
}).skipDuplicates();
...
function merge() {
  ...
  return _Bacon2["default"].mergeAll(keys.map(registerKey));
}

var menuNextE = merge(player1Keys.DOWN, player2Keys.DOWN, player1Keys.LEFT, player2Keys.LEFT).map(function () {
  return function (x) {
    return x - 1;
  };
});
var menuPrevE = merge(player1Keys.UP, player2Keys.UP, player1Keys.RIGHT, player2Keys.RIGHT).map(function () {
  return function (x) {
    return x + 1;
  };
});
var asE = merge(player1Keys.A, player2Keys.A);
var menuResetE = activePageP.map(function () {
  return function () {
    return 0;
  };
});

var menuIndexP = _Bacon2["default"].mergeAll(menuNextE, menuPrevE, menuResetE).filter(isGamePageP.not()).scan(0, function (index, func) {
  return func(index);
});

var worlds = [{ world: World.assembly, label: "Assembly", description: "Be the machine" }, { world: World.javaScript, label: "JavaScript", description: "Best proggaming language" }, { world: World.haskell, label: "Haskell", description: "Enjoy your burritos" }];

var navigation = {
  "#menu": [{ link: "#worldSelect", label: "Start game >", selected: false }, { link: "#howto", label: "How to play >", selected: false }],
  "#worldSelect": worlds.map(function (w) {
    return { link: "#game-hs", label: w.label + " >", description: w.description, selected: false };
  }),
  "#score": [{ link: "#menu", label: "< Back to main menu", selected: false }],
  "#howto": [{ link: "#menu", label: "< Back to main menu", selected: false }]
};

var navigationP = _Bacon2["default"].constant(navigation).sampledBy(activePageP, function (navigation, page) {
  return navigation.hasOwnProperty(page.hash) ? navigation[page.hash] : [];
}).sampledBy(menuIndexP, function (navigation, index) {
  // Wrap navigation index, i.e. index -1 equals last menu item, last index + 1, equals first menu item
  var active = wrapIndex(navigation.length, index);
  return navigation.map(function (n, i) {
    n.selected = i === active;
    return n;
  });
});

navigationP.sampledBy(asE).map(function (navigation) {
  return navigation.filter(function (n) {
    return n.selected;
  })[0];
}).onValue(function (item) {
  return window.location.hash = item.link;
});

var isWorldSelectP = activePageP.map(function (p) {
  return isGameHash(p.hash);
}).skipDuplicates();

var wrapIndex = function wrapIndex(length, index) {
  return (length + index % length) % length;
};

var activeWorldP = _Bacon2["default"].constant(worlds).sampledBy(menuIndexP, function (worlds, index) {
  return worlds[wrapIndex(worlds.length, index)].world;
}).map(function (world) {
  var blocks = world.split(/<<|>>/).map(parseBlock);
  return {
    length: blocks.map(function (b) {
      return b.text;
    }).join('').length,
    blocks: blocks
  };
...
var playerStatesP = _Bacon2["default"].combineAsArray([{
  keys: player1Keys,
  world: activeWorldP,
  specialsLeft: 3,
  consecutiveSpecialHits: 0,
  ...
  blockPosition: 0,
  step: 0
}].map(_Bacon2["default"].combineTemplate)).sampledBy(resetStateE).flatMapLatest(function (players) {
  return _Bacon2["default"].combineAsArray(players.map(function (player) {
    var normalE = sequenceStream(player.keys, [LEFT, RIGHT]);
    var specialE = registerKey(player.keys.A);
    var keysE = _Bacon2["default"].mergeAll(specialE.map(Const.KEY_SPECIAL), normalE.map(Const.KEY_NORMAL)).filter(gameIsActiveP);
    return gameTimeLeftP.sampledBy(keysE, function (timeLeft, keyType) {
      return { timeLeft: timeLeft, keyType: keyType };
    }).scan(player, function (state, timeAndKey) {
      return nextStep(_immutable2["default"].fromJS(state), timeAndKey).toJS();
    });
  }));
});

_Bacon2["default"].onValues(pageComponentE, playerStatesP, playerSettingsP, navigationP, function (template, states, settings, navigation) {
  return _react2["default"].render(template(freeze(states), freeze(settings), navigation), document.getElementById("main"));
});

function playersProgressedToEnd(states) {
  return states.reduce(function (end, s) {
    return s.progress === 100 && end;
  }, true);
}

gameIsActiveP.and(activePageP.map(function (p) {
  return p.timeLeft == 0;
}).or(playerStatesP.map(playersProgressedToEnd).toProperty(false))).filter(function (s) {
  return s === true;
}).onValue(function () {
  return window.location.hash = "#score";
});

var _Audio$loadAudioContext = Audio.loadAudioContext('assets/game.mp3', 'assets/menu.mp3', 'assets/menu-pick.wav', 'assets/menu-switch.wav', 'assets/type.wav', 'assets/perfect.wav', 'assets/autocomplete.wav', 'assets/miss.wav');

var _Audio$loadAudioContext2 = _slicedToArray(_Audio$loadAudioContext, 8);

var game = _Audio$loadAudioContext2[0];
var menu = _Audio$loadAudioContext2[1];
var menuPickSfx = _Audio$loadAudioContext2[2];
var menuSwitchSfx = _Audio$loadAudioContext2[3];
var typeSfx = _Audio$loadAudioContext2[4];
var perfectSfx = _Audio$loadAudioContext2[5];
var autocompleteSfx = _Audio$loadAudioContext2[6];
var missSfx = _Audio$loadAudioContext2[7];

// Audio

isGamePageP.onValue(function (isActive) {
  game.loop(isActive);
  menu.loop(!isActive);
});

asE.filter(isGamePageP.not()).onValue(function () {
  console.log("sfx: pick");
  menuPickSfx.play();
});

_Bacon2["default"].mergeAll(menuNextE, menuPrevE).filter(isGamePageP.not()).onValue(function () {
...
function orAll(cur, prev, fn) {
  ...
  return cur.reduce(function (eq, _, index) {
    return eq || fn(cur[index], prev[index]);
  }, false);
}

var gt = function gt(field) {
  return function (c, p) {
    return c[field] > p[field];
  };
};

playerStatesP.slidingWindow(2, 2).onValues(function (prev, cur) {
  var any = function any(fn) {
    return orAll(cur, prev, fn);
  };
  ...
  if (any(function (c, p) {
    return c.step == p.step && c.specialsLeft < p.specialsLeft;
  })) {
...
},{"./audio":5,"./components":6,"./const":7,"./worlds":9,"Bacon":1,"immutable":3,"react":4}],9:[function(require,module,exports){
"use strict";
